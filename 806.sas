...
* tarifas priorizadas governo - 202;
...
from orcmci.orc_tfa_prior_22019 a
left join mcicart.rel_atom_201907 b on a.cd_cli = b.cd_cli
where a.aaaa = year(date()) and mm in (7,8,9);
quit;


* realizando somat?? dos valores de tarifa por mci;
proc sql;
create table mci_sum_201907 as
select
CD_CLI
,sum(vl_tarf_rec) as vl_tarf_rec
from rlzmci.anlt_000000202_201907 b
group by 1;
quit;
...
,a.cd_cli as mci
,a.vl_orc as orc
,b.vl_tarf_rec as rlz
,a.aaaa
,a.mm
,a.anomes_tipo
from orcmci_526 a
left join mci_sum_201907 b on a.cd_cli = b.cd_cli;
quit;
...
%LET Keypass=tarifas-priorizadas-governo-2019-2-TMSaVyyAQQQDvWJFHGpAa5DW4IcURK3N1GuGt4LkvajZL1Nsih;
PROC SQL;
  CREATE TABLE EXPTROTINAS (TABELA_SAS CHAR(100), ROTINA CHAR(100));
  INSERT INTO EXPTROTINAS VALUES('work.aprc_dep', 'tarifas-priorizadas-governo-2019-2');

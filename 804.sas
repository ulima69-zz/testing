...
from orcmci.orc_fundos_rpps_cli_22019 a
...
,a.anomes_tipo
from orcmci_526 a
left join rlzmci.anlt_000000186_201907 b on a.cd_cli = b.cd_cli;
quit;
...
%LET Keypass=rentabilidade-de-fundos-rpps-2019-2-FScNmXa0WovLoVAr7Ub4x7TSNGziA0ULVmkNmXXHFfBobiv7zi;
PROC SQL;
  CREATE TABLE EXPTROTINAS (TABELA_SAS CHAR(100), ROTINA CHAR(100));
  INSERT INTO EXPTROTINAS VALUES('work.aprc_dep', 'rentabilidade-de-fundos-rpps-2019-2');

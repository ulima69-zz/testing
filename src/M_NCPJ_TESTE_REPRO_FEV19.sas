...
PROC SQL;
   ...
   CREATE TABLE CLIENTES_FINAL_550 AS 
      SELECT DISTINCT 
         ...
         t1.PONTOS,
         IFN(t1.VALENDO = 1 AND t1.QUALIFICADO = "Sim", t1.PONTOS, 0) as PT_CONSIDERADO,
...
PROC SQL;
   ...
   CREATE TABLE CLIENTES_COMPARA AS 
      SELECT DISTINCT 
		 ...
		 t1.PT_CONSIDERADO AS PTO_MES_ATU,
		 
		 IFN(t1.VALENDO = "Sim",COALESCE(t2.PTO_MES_ANT,0), 0) AS PTO_MES_ANT 
...
PROC SQL;
   ...
   CREATE TABLE CLIENTES_FINAL_328 AS 
      SELECT DISTINCT 
		 ...
		 (t1.PTO_MES_ATU - t1.PTO_MES_ANT) AS PT_CONSIDERADO

...
LIBNAME CIE '/dados/publica/ditec';
...
PROC SQL;
   CREATE TABLE VIPF492_190802 AS 
   SELECT *

      FROM CIE.VIPF492_190802.txt	  
      ;
QUIT;
...
%SumarizadorCNX( TblSASValores=CBR_QUALIFICACAO_GERAL_1,  TblSASColunas=COLUNAS_SUMARIZAR,  NivelCTRA=1,  PAA_PARA_AGENCIA=1,  TblSaida=CBR_QUALIFICACAO_GERAL_1, AAAAMM=201902); 
...
/*TRAZENDO O REALIZADO DE FEVEREIRO*/
/*TRAZENDO O REALIZADO DE FEVEREIRO*/
/*TRAZENDO O REALIZADO DE FEVEREIRO*/
/*TRAZENDO O REALIZADO DE FEVEREIRO*/
/*TRAZENDO O REALIZADO DE FEVEREIRO*/
...
PROC SQL;
   CREATE TABLE CONEX_MES_FEV AS
   SELECT DISTINCT
         
         t1.PREFDEP,
		 t1.CTRA,
		 t1.UOR,
         t1.RM02 FORMAT 32.2 AS PTO_MES_FEV
...
DATA ANALISE_REPRO;
	MERGE CBR_QUALIFICACAO_GERAL_5 CONEX_MES_FEV;
	BY PREFDEP CTRA UOR;
RUN;
...
PROC SQL;
   ...
   SELECT t1.PREFDEP, t1.CTRA, T1.UOR, t1.PTO_MES_FEV AS RLZ_ATUAL, t1.TOTAL AS RLZ_REPRO, (t1.TOTAL - t1.PTO_MES_FEV) FORMAT 32.2 AS DIFERENCA
...
%SumarizadorCNX( TblSASValores=RELATORIO_FINAL,  TblSASColunas=COLUNAS_SUMARIZAR,  NivelCTRA=1,  PAA_PARA_AGENCIA=1,  TblSaida=RELATORIO_FINAL, AAAAMM=201902); 
